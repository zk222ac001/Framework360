...
INSERT INTO "new_Bruger" ("createdAt", "createdFromRequestId", "efternavn", "email", "erAktiv", "fornavn", "id", "mustChangePassword", "password", "rolle", "sidsteLogin", "updatedAt", "virksomhedId") SELECT "createdAt", "createdFromRequestId", "efternavn", "email", "erAktiv", "fornavn", "id", "mustChangePassword", "password", "rolle", "sidsteLogin", "updatedAt", "virksomhedId" FROM "Bruger";
DROP TABLE "Bruger";
